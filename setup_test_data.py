...
try:
    ...
    print("❌ Не удалось импортировать модули из папки backend")
    print("💡 Убедись, что ты находишься в папке t2_hack")
    print("   и что папка backend существует рядом с этим скриптом")
    sys.exit(1)
